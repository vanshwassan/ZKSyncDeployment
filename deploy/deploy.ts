...
export default async function (hre: HardhatRuntimeEnvironment) {
    ...
    const airnodeAddress = "0xbD5263fa8c93Deb3417d49E63b444cBd541922FD";
...
// Create deployer object and load the artifact of the contract we want to deploy.
  ...
  const requesterContract = await deployer.deploy(requesterArtifact, [airnodeAddress]);
...
// make the request
    const makeReq = await requesterContract.makeRequest(
        airnode,
        endpointId,
        sponsor,
